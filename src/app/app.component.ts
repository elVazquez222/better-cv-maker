...
export class AppComponent {
  ...
  professionalInfoInputs: Array<TextInput> = [
    ...
    { label: "Further Skills", type: "text", value: "Angular, Python, ReactNative, UI/UX, Flutter, AI/ML, GraphQL, ASP.NET, Express, Node.js" },
  ...
  workExperienceEntries: Array<WorkExperienceEntry> = [
    ...
    { title: 'Web Developer', location: 'CHECK 24, Münster', description: 'Building the hotel comparison website hotel.check24.de in a Team of 10+ FrontendDevelopers. Collaborating with other teams using SCRUM, Kanban, Slack, zoom and realizing new features in close cooperation with the product management using Jira, Adobe XD and a lot of hot coffee.', time: '2020 – 2022', skills: 'React.js, TypeScript, PHP, REST, Jira, SASS, Twig, Mobx, Docker, MVC, UI/UX, git' },
