...
export class AppComponent {
  ...
  workExperienceEntries: Array<WorkExperienceEntry> = [
    { title: 'Web Developer', location: 'Bundeswehr, Germany', description: 'Creating innovative new apps for the members of the German Army to facilitate every day life in Service.', time: '2022 - planned until 01.11.2023', skills: 'Vue.js, JavaScript, SASS, Docker, gitlab, KeyCloak' }
    { title: 'Web Developer', location: 'CHECK 24, Münster', description: 'Building the hotel comparison website hotel.check24.de in a Team of 10+ FrontendDevelopers. Collaborating with other teams using SCRUM, Kanban, Slack, zoom and realizing new features in close cooperation with the product management using Jira, Adobe XD and hot coffee', time: '2020 - 2021', skills: 'React.js, TypeScript, PHP, REST, Jira, SASS, Twig, Mobx, Docker, MVC, UI/UX, git' }
    { title: 'Frontend Developer', location: 'German Army, Bonn', description: 'Refactoring and extending the existing Microsoft Sharepointbased intranet using React JS and RESTful API to allow to the employees to display and manage speci:c data on a personalized dashboard. SideProjectW Building a digital Kanban board that was used during the COVID19 restrictions using React JS and Firebase.', time: '2019 - 2020', skills: 'React.js, JavaScript, Sharepoint, REST, git, Kanban, Ui-Fabric, firebase' }
    { title: 'Reservist', location: 'German Army, Schwarzenborn', description: 'Participating in military maneuvers, such as Allied Spirit X, as Infantryman and IT-Specialist.', time: '2018 - 2019', skills: 'Army command and information system, mil. stuff' }
    ...
    { title: 'Internship Web-Development', location: 'Setup-Design, Hannover', description: 'Web Development internship. Applying what I had learned about web development and learning a lot about professional web development and design.', time: '2013 - 2014', skills: 'JavaScript, jQuery, Design, PhotoShop, Bootstrap, HTML/CSS, PHP, MySQL' }
    ...
    { title: 'Military Service', location: 'German Army (Bundeswehr)', description: 'Serving as an Infantryman inter alia in JgBtl292 in Donaueschingen. Building knowledge of human nature and discipline, which are also helpful in civilian work and everyday life.', time: '2005 - 2010', skills: 'soft skills, military skills, leading skills' }
  ]
