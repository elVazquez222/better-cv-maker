...
export class AppComponent {
  ...
  workExperienceEntries: Array<WorkExperienceEntry> = [
    { title: 'Web Developer', location: 'Bundeswehr, Germany', description: 'Creating innovative new apps for the members of the German Army to facilitate every day life in Service.', time: '2022 - today', skills: 'Vue.js, JavaScript, SASS, Docker, gitlab, KeyCloak' }
    ...
    { title: 'Internship Webdesign', location: 'Setup-Design, Hannover', description: 'Web Development internship. Applying what I had learned about web development and learning a lot about professional web development and design.', time: '2013 - 2014', skills: 'JavaScript, jQuery, Design, PhotoShop, Bootstrap, HTML/CSS, PHP, MySQL' }
